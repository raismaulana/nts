            ...
            <div class="container-fluid">
                ...
                <div class="modal fade" id="Modal_Edit" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel">Update Status Laporan Kegiatan Staf</h5>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
                            <form action="<?= base_url('KASI/Laporan_kegiatan_staf/update'); ?>" method="post">
                                <form id="form_edit" type="POST" enctype="multipart/form-data">
                                    <div class="modal-body">
                                        <input type="text" class="form-control" name="edit_id_laporan" id="edit_id_laporan" hidden>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('#table_data_laporan').DataTable({
                ...
                "ajax": {
                    "url": "http://localhost/nts/KASI/laporan_kegiatan_staf/select_all",
                    "method": "GET"
                },
                "columns": [{
                        "data": "nama_pengguna"
            ...
            $('#data_laporan').on('click', '.item_detail', function() {
                $.ajax({
                    url: "<?php echo base_url('KASI/Laporan_kegiatan_staf/get_detail'); ?>",
                    type: "POST",
                    dataType: 'JSON',
                    data: {
            ...
            $('#data_laporan').on('click', '.item_edit', function() {

                $('[name="edit_id_laporan"]').val($(this).data('product_code'));
