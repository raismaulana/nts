            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li> <a class="waves-effect waves-dark" href="<?php echo base_url().'KASI/Laporan_kegiatan_staf'?>" aria-expanded="false"><i class="icon-doc"></i><span class="hide-menu">Laporan Kegiatan &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Harian Staf</span></a>
                        </li>
                    </ul>
                </nav>
