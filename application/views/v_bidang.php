...
<body class="fixed-layout skin-blue mini-sidebar">
    ...
    <div class="preloader">
        <div class="loader">
            ...
            <p class="loader__label">Data Bidang</p>
        </div>
    </div>
    <!-- ============================================================== -->
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h4 class="text-themecolor">Data Bidang</h4>
                    </div>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" name="nama" id="nama" class="form-control" placeholder="Bidang">
                                        </div>
                                    </div>
                                </div>
                ...
                <form id="form_tambah" type="POST" enctype="multipart/form-data">
                    <div class="modal fade" id="Modal_Tambah_Kabid" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-lg" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalLabel">Tambah Data Kepala Bidang</h5>
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                        <span aria-hidden="true">&times;</span>
                                    </button>
                                </div>
    ...
    <!-- <script>
        ...
        tampil_data();   //pemanggilan fungsi tampil bidang.

        $('#mydata').dataTable();

        //fungsi tampil bidang
        function tampil_data(){
          $.ajax({
            type  : 'ajax',
            url   : '<?php echo base_url()?>bidang/data_bidang',
            async : false,
            datatype : 'json',
            success : function(data){
              ...
              for(i=0; i<data.length; i++){
                html += '<tr>'+
                        '<td>'+data[i].nama_bidang+'</td>'+
                        '<td style= "text-align:right;">'+
                            '<a href="javascript:void(0);" data-toggle="modal" data-target="#Modal_Edit" class="btn btn-info btn-sm item_edit"  data-product_name="'+data[i].nama_bidang+'" >Edit</a>'+' '+
        ...
        $('#btn_simpan').on('click',function(){
          ...
          $.ajax({
            type : "POST",
            url  : "<?php echo base_url('bidang/simpan_bidang')?>",
            dataType : "JSON",
            data : {bidangg:bidangg },
            success: function(data){
                $('[name="bidangg"]').val("");
