                    ...
                    <ul id="sidebarnav">
                        ...
                        <li> <a class="has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="icon-people"></i><span class="hide-menu">Staf</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="<?php echo base_url().'KABID/Kegiatan_staf'?>">Data Kegiatan Harian Staf</a></li>
                                <li><a href="<?php echo base_url().'KABID/Data_staf'?>">Data Staf </a></li>
                            </ul>
                        </li>
                        <li> <a class="waves-effect waves-dark" href="<?php echo base_url().'KABID/Laporan_kegiatan_staf'?>" aria-expanded="false"><i class="icon-doc"></i><span class="hide-menu">Laporan Kegiatan &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Harian Staf</span></a>
                        </li>
                    </ul>
                </nav>
